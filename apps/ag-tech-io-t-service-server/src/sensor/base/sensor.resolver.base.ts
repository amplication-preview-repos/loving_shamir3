...
export class SensorResolverBase {
  ...
  @graphql.ResolveField(() => [DataPoint], { name: "dataPoints" })
  async findDataPoints(
    @graphql.Parent() parent: Sensor,
    @graphql.Args() args: DataPointFindManyArgs
  ): Promise<DataPoint[]> {
    const results = await this.service.findDataPoints(parent.id, args);
  ...
  async getFarm(@graphql.Parent() parent: Sensor): Promise<Farm | null> {
